...
class SphinxClient
{
	...
	{
		assert(0 === $ranker || 1 <= $ranker && SPH_RANK_TOTAL > $ranker);
	...
	function SetSortMode($mode, $sortby = "")
	{
		...
		assert(SPH_SORT_RELEVANCE == $mode || 0 < strlen($sortby));
		$this->_sort = $mode;
		$this->_sortby = $sortby;
	}
	 ...
	 * @param array $values
	 * @param boolean $mva
	 * @param boolean $ignorenonexistent
	 * @return mixed
	 */
